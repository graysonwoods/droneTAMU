...
set(MSG_I_FLAGS "-Ispinnaker_sdk_camera_driver:/home/aims/catkin_ws/src/spinnaker_sdk_camera_driver-master/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/aims/catkin_ws/src/spinnaker_sdk_camera_driver-master/msg/SpinnakerImageNames.msg" NAME_WE)
add_custom_target(_spinnaker_sdk_camera_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "spinnaker_sdk_camera_driver" "/home/aims/catkin_ws/src/spinnaker_sdk_camera_driver-master/msg/SpinnakerImageNames.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(spinnaker_sdk_camera_driver
  "/home/aims/catkin_ws/src/spinnaker_sdk_camera_driver-master/msg/SpinnakerImageNames.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/spinnaker_sdk_camera_driver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/spinnaker_sdk_camera_driver\")")
  # install generated code
  install(
